    ...
    <ion-content style="background-color: #c6e7f0;" fullscreen #updateDisplayName>
      ...
      <ion-list style="margin: 0; padding-left: 16px; padding-right: 16px; padding-bottom: 16px;">
        <ion-item
          ...
          <ion-label floating>拼單簡介</ion-label>
          <ion-textarea fz-elastic type="text" #projectname id="projectname"
                     [(ngModel)]="data.Project.plandesc"></ion-textarea>
        </ion-item>
      </ion-list>
      <div padding>
